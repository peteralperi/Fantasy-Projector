...
for week in range(9,19):
    url = 'https://www.fantasypros.com/nfl/stats/wr.php?year=2022&week={}&range=week'.format(week)
...
wb_name = "bigboy.xlsx"
sheet_name = "WR"
df_mapping = {"A1": df, "A500": df1, "A1000": df2, "A1500":df3, "A2000":df4, "A2500":df5, "A3000":df6, "A3500":df7, "A4000":df8, "A4500":df9}
